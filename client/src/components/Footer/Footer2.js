    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>Health Connect is a leading one stop Online Store in the India. We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Health Connect, Inc.  All rights reserved</h3>
