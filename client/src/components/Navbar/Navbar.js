        ...
        <nav>
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1">Medical Equipments</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Emergency Equipments</Dropdown.Item>
                        <Dropdown.Item href="#/action-3">Medicinal Products</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>About Us</a>
