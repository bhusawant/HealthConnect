...
const OrderSuccessful = ({ orderid, message, redirecto }) => {
    ...
    const [orderdata, setorderdata] = useState({
        ...
        CustomerName: 'Medhaj Sarang',
        CustomerShipToAddress: 'B-1602, Bellezza of Shanti Sadan CHS, Mulund, East, Mumbai, Maharashtra 400081',
        CustomerEmail: 'sarangmedhaj@gmail.com',
        OrderItems: [
            {
